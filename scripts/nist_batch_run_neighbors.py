...
DEFAULT_SCANNER = REPO_ROOT / "scripts" / "nist_wct_log_spectral_scan_FIXED.py"
DEFAULT_OUT_ROOT = REPO_ROOT / "outputs" / "batch_neighbors"

DEFAULT_FILES = [
    str(DATA_DIR / "Ni_lines.csv"),
    str(DATA_DIR / "Co_lines.csv"),
    str(DATA_DIR / "Cr_lines.csv"),
    str(DATA_DIR / "Mn_lines.csv"),
    str(DATA_DIR / "Ti_lines.csv"),
]
